/*
  ...
  gengetopt --unamed-opts --default-optional
...
void clear_args (struct gengetopt_args_info *args_info)
{
  args_info->mode_arg = mode_arg_BO;
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'm':	/* execution mode.  */
        
        
          if (update_arg( (void *)&(args_info->mode_arg), 
               &(args_info->mode_orig), &(args_info->mode_given),
              &(local_args_info.mode_given), optarg, cmdline_parser_mode_values, "BO", ARG_ENUM,
